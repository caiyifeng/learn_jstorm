 ...
 * builder.setBolt(&quot;3&quot;, new TestWordCounter(), 3).fieldsGrouping(&quot;1&quot;, new Fields(&quot;word&quot;))
...
public class TopologyBuilder {
    ...
    public BoltDeclarer setBolt(String id, IRichBolt bolt, Number parallelism_hint) {
        //检测是否id已经用过
        validateUnusedId(id);
        //将bolt的基本信息config,parallelism以及封装以后放入_commons
     ...
     *            components that want to consume this spout's outputs.
     * @param parallelism_hint the number of tasks that should be assigned to
     *            execute this spout. Each task will run on a thread in a
    ...
    /**
     * 提供了8中分组方式 fields， shuffle， all， none， direct， custom_object，
     * custom_serialized， local_or_shuffle
     */
    protected class BoltGetter extends ConfigGetter<BoltDeclarer> implements BoltDeclarer {
        ...
        /**
         * 将ComponentCommon里面的inputs信息里面加入输入的Blot/Spout Id以及Grouping信息
         */
