...
public class TopologyAssign implements Runnable {
    ...
    public Assignment mkAssignment(TopologyAssignEvent event) throws Exception {
        ...
        Map<String, String> nodeHost = getTopologyNodeHost(context.getCluster(), context.getOldAssignment(),
                assignments);
     ...
     */
    public static Set<Integer> getChangeTaskIds(Set<ResourceWorkerSlot> oldWorkers, Set<ResourceWorkerSlot> workers) {
     ...
     * 获得所有supervisor已经dead，但是还没有dead的任务
     */
     ...
     * @throws Exception
     */
    public static void getFreeSlots(Map<String, SupervisorInfo> supervisorInfos, StormClusterState stormClusterState)
            throws Exception {
