...
public class NimbusUtils {
    ...
    public static boolean isTaskDead(NimbusData data, String topologyId, Integer taskId) {
        ...
        int taskHBTimeout = JStormUtils.parseInt(data.getConf().get(Config.NIMBUS_TASK_TIMEOUT_SECS));
    ...
    public static TaskSummary mkSimpleTaskSummary(ResourceWorkerSlot resource, int taskId, String component,
                                                  String componentType, String host, int uptime) {
    ...
    public static Map<Integer, TaskSummary> mkTaskSummary(StormClusterState zkClusterState, Assignment assignment,
    ...
    public static void updateMetricMonitorStatus(StormClusterState clusterState, String topologyId, boolean isEnable)
            throws Exception {
        StormMonitor stormMonitor = new StormMonitor(isEnable);
        clusterState.set_storm_monitor(topologyId, stormMonitor);
    }

    public static void updateMetricsInfo(NimbusData data, String topologyId, Assignment assignment) {
